...
const CaseForChangeForm = () => {
  ...
  return (
    <div className="flex flex-col w-full h-full space-y-4 py-6">
      <h1 className="text-center text-primary-500 text-[26px]">
        Final Draft Case For Change
      </h1>
      <form
        action=""
        className="flex flex-col w-full overflow-y-auto max-h-[700px]  scrollbar-thin scrollbar-thumb-zinc-200"
      >
        ...
        <div className="flex flex-col w-full px-20 py-10 space-y-16  ">
          <div className="w-full flex items-center border-b border-b-border py-4">
            <h1 className="text-[22px] text-black">
              What is in it for the affected stakeholders? What would the
              benefits be to the affected stakeholders?
            </h1>
          </div>
          <h1>
            Complete the sentence “With this change the affected stakeholders
            will
          </h1>
        ...
        <div className="flex flex-col w-full px-20 py-10 space-y-16  ">
          <div className="w-full flex items-center border-b border-b-border py-4">
            <h1 className="text-[22px] text-black">
              What may affected stakeholders be concerned about ( that will
        ...
        <div className="flex flex-col w-full px-20 py-10 space-y-16  ">
          ...
          <h1>
            Complete the sentence “ We realize that you may be concerned about
            and would like to (insert your response i.e. assure you .... /
            advise that .... )
          </h1>
          <div className="flex flex-col w-full space-y-24">
            <InputField
        ...
        <div className="flex flex-col w-full px-20 py-10 space-y-16  ">
          ...
          <h1>
            Complete the sentence “We are also aware that some stakeholders may
            be expecting ...”
          </h1>
          <div className="flex flex-col w-full space-y-24">
            <InputField
        ...
        <div className="flex flex-col w-full px-20 py-10 space-y-16  ">
          <div className="w-full flex items-center border-b border-b-border py-4">
            <h1 className="text-[22px] text-black">
              Only complete this if relevant- What would you like to say to
